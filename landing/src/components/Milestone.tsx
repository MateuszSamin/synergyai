...
const Milestone = ({ milestoneTasks, ...props }: any) => {
    ...
    return (
        <div className='min-w-[25rem] h-[35rem] bg-gradient-to-b from-black to-transparent rounded-3xl flex-col px-6 py-6'>
                ...
                {milestoneTasks.map((task: any, i: number) => {
                    return (
                        <div key={i} className="space-x-4 flex lex-row items-center">
                            <div className={`rounded-full min-w-8 w-8 h-8 ${task.done === true ? 'border-green' : 'border-gray-400'} flex items-center justify-center border-[1px] `}>
