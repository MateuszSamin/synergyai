  ...
  return (
    <div className="bg-background text-white font-sora relative z-30">
      ...
      <Container>
        ...
        />
        <FaqItem
          question="Does the team have expercience in blockchain / AI?"
          answer="All members of the team have past experience in blockchain. The management has previosly founded a blockchain software development company. They also have expertise in AI, as they also have work experience in this field."
        />
        <FaqItem
          question="Can I join you?"
          answer={`We're always happy to work with talented people. Contact us at contact@synergyai.io and let's talk!`}
        />
        <FaqItem
          question="Can I invest?"
          answer={`We are currently during our seed fundraising round. Contact us at contact@synergyai.io to learn about the $SYNAI token.`}
        />
        <FaqItem
          question="What blockchain are you using?"
          answer="We are working with the Ethereum blockchain, but choose to remain blockchain agnostic. We will later expand our platform to support other blockchains."
        />
        <FaqItem
          question="How can I contact you?"
          answer="Email us at contact@synergyai.io or text CEO directly on Telegram @karolproksa."
        />
      </Container>
    </div>
  );
