    ...
    return (
        <div className='w-full'>
            <Container className='justify-between bg-background lg:h-auto py-24   text-white items-center flex flex-col '>
                ...
                <p className='text-white tracking-wide text-4xl mt-12'>Who{"'"}s working on this <span className='text-green'>suff</span>?</p>
                <div className='flex flex-col 2xl:flex-row mt-20  mx-auto '>
                    <div className='flex flex-col mx-auto lg:flex-row space-y-6 lg:space-y-0 lg:space-x-10'>
                        {DevTeam.slice(0, 3).map((member, index) => {
                            return (
                                <div key={index} className='flex flex-col text-center  w-[13rem] relative z-10'>
                                    <div className="h-[10rem] w-[10rem] mx-auto cursor-pointer ">
                                        <Image src={Outline} alt="outline" className={`absolute ${member.outlineStyling}  z-20`} />
                                        <Image src={member.img} alt='antoni' className=' w-[10rem] absolute z-20' />
                                        <Image src={Flare} alt="flare" className={` ${member.flareStyling} absolute z-10`} />
                                        <Image src={Dot} alt="flare" className={` ${member.dotStyling} absolute z-10`} />
                                    </div>
