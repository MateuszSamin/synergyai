				...
				<div className='flex flex-col xl:flex-row items-center'>
					<div className='space-y-6 flex-row'>
						...
						<p className='tracking-widest text-sm text-center lg:text-left'>
							We are building a platform that utilizes AI to
							protect users from fraud in DeFi. <br /> Our mission
							is providing super-advanced analysis and security
						...
						<div className='grid grid-cols-1 md:grid-cols-2 gap-8 lg:grid-cols-2 w-full lg:w-[40rem] justify-center 2xl:w-[40rem] lg:gap-y-10 2xl:gap-10'>
							<div className='w-[20rem] mx-auto lg:mx-0 lg:mr-auto'>
								...
								<p className='lg:w-2/3 mt-2 justify-center text-center lg:text-left'>
									You will be able to discover projects before
									others, make investment decisions based on
									metrics provided by AI, and evaluate risk
									more accurately.
								</p>
							</div>
							<div className='w-[20rem]  mx-auto lg:mx-0 lg:mr-auto'>
								...
								<p className='lg:w-2/3 mt-2 justify-center text-center lg:text-left'>
									Be safeguarded from rug-pulls. Our AI models
									scan smart contracts to identify relevant
									features that could prevent purchases or
									mint new tokens.
								</p>
							</div>
							<div className='w-[20rem]  mx-auto lg:mx-0 lg:mr-auto'>
								...
								<p className='lg:w-2/3 mt-2 justify-center text-center lg:text-left'>
									Staking our token will produce real yield, a
									percent of the total platform’s fees paid in
									ETH.
								</p>
							</div>
						</div>
				...
				<div className='flex flex-col lg:flex-row w-full items-center justify-between mt-10 lg:mt-0'>
					<div className='grid grid-cols-1 md:grid-cols-2 gap-8 lg:grid-cols-2 w-full lg:w-[40rem] justify-center 2xl:w-[40rem] lg:gap-y-10 2xl:gap-10'>
						<div className='w-[20rem] mx-auto lg:mx-0 lg:mr-auto'>
							...
							<p className='lg:w-2/3 mt-2 justify-center text-center lg:text-left'>
								Users who are fans of decentralized markets and
								memecoins can use our MEMECOINS GENERATOR to
						...
						<div className='w-[20rem]  mx-auto lg:mx-0 lg:mr-auto'>
							...
							<p className='lg:w-2/3 mt-2 justify-center text-center lg:text-left'>
								The project founders are removing liquidity?
								Frontrun them! Synergy FRONTRUNNER monitors
								mempool transactions and automatically sells
								your tokens before the founders manage to rug
								pull.
							</p>
						</div>
						<div className='w-[20rem]  mx-auto lg:mx-0 lg:mr-auto'>
							...
							<p className='lg:w-2/3 mt-2 justify-center text-center lg:text-left'>
								Every developer on the Ethereum network can take
								advantage of a free, brief audit of their token
								contract for security and hidden features. The
